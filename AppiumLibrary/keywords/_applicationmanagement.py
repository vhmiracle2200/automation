...
class _ApplicationManagementKeywords(KeywordGroup):
    ...
    def close_all_applications(self):
        ...
        This keyword is meant to be used in lys_test.robot or suite teardown to
        make sure all the applications are closed before the lys_test.robot execution
        finishes.
    ...
    def launch_application(self):
        ...
        This keyword can be used to launch application during lys_test.robot case or between lys_test.robot cases.

        This keyword works while `Open Application` has a lys_test.robot running. This is good practice to `Launch Application`
        and `Quit Application` between lys_test.robot cases. As Suite Setup is `Open Application`, `Test Setup` can be used to `Launch Application`
    ...
    def quit_application(self):
        ...
        This keyword can be used to close application during lys_test.robot case or between lys_test.robot cases.
