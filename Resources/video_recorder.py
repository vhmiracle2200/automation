...
class VideoRecorder:
    ...
    def start_recorder(self, filename="output/video.webm", max_length=800, monitor=1, scale=1.0, fps=4, force_fps="False", fourcc="VP80"):
...
record_obj = VideoRecorder()


def create_recorder(video_name):
    record_obj.start_recorder(video_name + '.webm', fps=25, scale=0.9, force_fps="True")


def stop_recorder():
    logger.log(1, 'Recorder will be stop.')
    record_obj.stop_recorder()